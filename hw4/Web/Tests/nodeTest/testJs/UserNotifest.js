...
driver.get("file:///media/navidx/E658E07858E0493F/sharif%20uni/SystemAnalyzeDesign/project/git/hw4/Web/Phase%204-user/Notifications.html");
...
//     driver.findElement(webdriver.By.id('telnum')).sendKeys('09197104871');
 //   setTimeout(()=>{driver.findElement(webdriver.By.id('submitForm')).click()},2000)
    if(driver.findElement(webdriver.By.id('link1'))){
        console.log("success")
