...
driver.get("file:///media/navidx/E658E07858E0493F/sharif uni/SystemAnalyzeDesign/project/git/hw4/Web/Phase4-employee/Messages.html");
...
//     driver.findElement(webdriver.By.id('telnum')).sendKeys('09197104871');
    setTimeout(()=>{driver.findElement(webdriver.By.id('respond1')).click()},2000)
